...
function mbmShowContentCommentForm($content_id=0){
	...
	$buf .= '<div id="moreContentComments" style="cursor:pointer; margin-bottom:20px; clear:both; display:block;"><strong>'.$lang['comments']['previous_comments'].' &raquo;</strong></div>';
