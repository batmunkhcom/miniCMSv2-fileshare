...
if($DB->mbm_check_field('id',$_GET['content_id'],'menu_contents')==0){
	...
	<table width="100%" border="0" cellspacing="2" cellpadding="3">
	  ...
	  switch($_GET['action']){
		case 'delete':
			$r_delete_process = $DB->mbm_query("DELETE FROM ".PREFIX."menu_videos WHERE id='".$_GET['id']."' LIMIT 1");
	  ...
	  $q_content_photos = "SELECT * FROM ".PREFIX."menu_videos WHERE content_id='".$_GET['content_id']."' ORDER BY id";
