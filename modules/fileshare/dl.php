...
<form id="fileInfo" name="fileInfo" method="post" action="">
  <div align="center" id="countDownDiv" style="margin:12px;"> Та
    <input type="text" id="countDownTime" name="countDownTime" value="<?=$config_fileshare['next_file_dl_limit'][$_SESSION['lev']]?>" style="border:0px; font-size:14px; background-color:#FFFFFF; text-align:center; font-weight:bold;" size="1" disabled="disabled" />
