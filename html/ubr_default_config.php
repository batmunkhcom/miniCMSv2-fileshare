...
$_CONFIG['upload_dir']                            = $_SERVER['DOCUMENT_ROOT'] . '/'.$config_fileshare['storage_dir'].'/';                                                  // Path to upload directory
...
$_CONFIG['allow_extensions']                      = '(wma|pdf|dmg|wmv|mpg3|mpg|mpeg|avi|mov|jpg|jpeg|gif|bmp|png|tiff|flv|zip|gz|tar|rar|doc|docx|xls|xlsx|ppt|pptx|ppts)';                                  // Include file extentions that are allowed to be uploaded
...
$_CONFIG['path_to_upload']                        = 'http://' . $_SERVER['HTTP_HOST'] . '/'.$config_fileshare['storage_dir'].'/';                                           // Used for a web link to the uploaded file
...
$_CONFIG['to_email_address']                      = 'enkhorgil@ubedn.mn';                                                    // To Email addresses

$_CONFIG['from_email_address']                    = 'enkhorgil@ubedn.mn';                                                                         // From email address

$_CONFIG['log_uploads']                           = 0;                                                                                            // Log all uploads

$_CONFIG['log_dir']                               = '/home/ubedn/tmp/ubr_logs/';                                                                             // Path to log directory
